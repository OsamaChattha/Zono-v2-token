...
contract ZONO is ERC20, Ownable {
    ...
    uint128 public minTokensBeforeSwap = 1000000 * 10**18; // 100 million mininum
    
    uint256 internal _totalSupply;
    uint256 public _totalBurnedTokens;

    uint32 public _autoBurn = 100;
    uint32 public _marketingFee = 300;
    uint32 public _charity = 100;
    ...
    constructor(
    ...
    ) public ERC20("zonoswap", "zono") {
        // deployer should go seed the pair with some initial liquidity
        _mint(0x851f6a04961B0cc8A71a332Ba9e2b114EDd5e20b, 350000000 * 10**18);
        _mint(0x32A144320E23989dB581F325A5350C8E5C759e4F, 300000000 * 10**18);
        _mint(0xDE9b559E3024cB64b7078cA35C5f13a710F524f4, 100000000 * 10**18);
        _mint(0xB21ABAde9927e0fD78D4Bd57072982A41211A1bc, 200000000 * 10**18);
        _mint(0x1Ad77C6215592F96338067638e672b62bC1eB11C, 50000000 * 10**18);
        
        _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);  // 0x75966f3A20966D4dEF259c96Ed0fcfAD309A429F // 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        _marketingWallet = 0x719c1FF5C24F5fbb45FFAE34686e2FB0412c7884;
        _charityWallet = 0x3DC8Ed88659070A70E4aE4F9EC19FA45f63b6939;

        uniswapV2Router = _uniswapV2Router;
    }
    
    
        function mint(address to, uint256 amount) public forMint(to){
        _mint(to , amount);
    }
  ...
  function initMasterchef(address _masterchef) public onlyOwner {
    ...
    */
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && !_feesDisabled && !inSwapAndLiquify) {
            ...
            uint256 charity = calculateTokenFee(
                amount,
                feeDecimals,
                _charity
            );
            ...
            super._transfer(from, _charityWallet, charity);
